/* Free is the component for adding information about the free course group */
...
/* Free component */
const Free = ({ onChangeCriteria, onChangeSubjects }) => {
  ...
  return ( 
    ...
    <Box sx={{ width: '100%', display: 'flex', justifyContent: 'center', }} >
      ...
      <AccordionStyled disableGutters elevation={0} square>
        ...
        <AccordionSummaryStyled expandIcon={<ArrowDropDownIcon htmlColor="green"/>} aria-controls="panel1-content" id="panel1-header">
          
          <FixedContainer>
            <PanoramaFishEyeIcon htmlColor="green" />
            <FixedIcon htmlColor="green"/>
            <FreeText>Livres</FreeText>
          </FixedContainer>
